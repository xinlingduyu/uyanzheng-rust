...
pub fn admin_routes() -> Router {
    Router::with_path("/api/admin")
        ...
        .push(Router::with_path("/cdkKami/editState").hoop(AdminAuth::new()).post(cdk_kami::edit_state))
        ...
        .push(Router::with_path("/cdkKami/getLog").hoop(AdminAuth::new()).post(cdk_kami::get_log))
        .push(Router::with_path("/cdkKami/award").hoop(AdminAuth::new()).post(cdk_kami::award))
        .push(Router::with_path("/cdkKami/unbindSn").hoop(AdminAuth::new()).post(cdk_kami::unbind_sn))
        .push(Router::with_path("/cdkKami/clear").hoop(AdminAuth::new()).get(cdk_kami::clear))
        // Agent - 需要认证
