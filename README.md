...
| fluent-templates | 国际化（Fluent） |
| maxminddb | GeoIP 地理定位 |
| anyhow, thiserror | 错误处理 |
| tracing, tracing-subscriber | 日志和追踪 |
| serde, serde_json | 序列化 |
| config | 配置管理 |
| once_cell, lazy_static | 全局变量 |
| validator | 数据验证 |
| parking_lot | 并发原语 |
| num_cpus | CPU 信息 |
| chrono | 时间处理 |
| rand, hmac, sha2, base64 | 加密和随机 |
| rust-embed, mime_guess | 静态文件嵌入 |
| proc-macro2, quote, syn | 过程宏依赖 |
| rquickjs | QuickJS 绑定（用于云函数） |
| pprof | 性能分析（火焰图） |
