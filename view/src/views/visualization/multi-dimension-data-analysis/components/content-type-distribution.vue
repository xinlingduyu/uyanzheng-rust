<template>
  ...
  >
    <sa-chart style="height: 222px" :options="chartOption" />
  </a-card>
</template>
    ...
    data: [
      {
        ...
        name: '纯文本',
        symbol: 'none',
        itemStyle: { color: isDark ? '#6CAAF5' : '#249EFF' }
      },
      {
        value: [2250, 17000, 21000, 23500, 42950, 22000],
        name: '图文类',
        symbol: 'none',
        itemStyle: { color: isDark ? '#A079DC' : '#313CA9' }
      },
      {
        value: [5850, 11000, 26000, 27500, 46950, 18000],
        name: '视频类',
        symbol: 'none',
        itemStyle: { color: isDark ? '#3D72F6' : '#21CCFF' }
      }
    ]
  }]
}))
